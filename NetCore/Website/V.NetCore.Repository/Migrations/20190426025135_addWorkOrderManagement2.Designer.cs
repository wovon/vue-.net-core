...
namespace V.NetCore.Repository.Migrations
{
    ...
    [Migration("20190426025135_addWorkOrderManagement2")]
    partial class addWorkOrderManagement2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("V.NetCore.Repository.Domain.History", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50);
                    ...
                    b.Property<int>("Wom_ID");

                    b.Property<string>("WorkOrderManagementId");

                    b.HasKey("Id");

                    b.HasIndex("WorkOrderManagementId");
            ...
            modelBuilder.Entity("V.NetCore.Repository.Domain.History", b =>
                {
                    b.HasOne("V.NetCore.Repository.Domain.WorkOrderManagement.WorkOrderManagement")
                        .WithMany("Histories")
                        .HasForeignKey("WorkOrderManagementId");
                });
            ...
            modelBuilder.Entity("V.NetCore.Repository.Domain.ProjectWorkflow", b =>
                {
                    ...
                    b.HasOne("V.NetCore.Repository.Domain.Workflow", "Workflow")
                        .WithMany("ProjectWorkflow")
